...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center"> تعديل كود سنة مالية جديدة   
  ...
  <div class="col-md-12">
            ...
            <div class="col-md-12">
               ...
               <button class="btn btn-sm btn-success" type="submit" name="submit">عدل السنة </button>
               <a href="{{ route('finance_calender.index') }}" class="btn btn-sm btn-primary" >رجوع</a>
               </div>
            </div>
      </form>
